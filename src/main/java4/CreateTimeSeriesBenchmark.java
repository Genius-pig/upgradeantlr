...
public class CreateTimeSeriesBenchmark {
  ...
  public Operator select() {
    return driver.parse(getSql(pathNodeLength,pathNodeNumber), zoneId);
  }

  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(CreateTimeSeriesBenchmark.class.getSimpleName())
        .forks(1)
        .warmupIterations(10)
