...
public class DeleteTimeSeriesBenchmark {
  ...
  public Operator select() throws QueryProcessException, MetadataException, ParseException {
    AstNode astTree = ParseGenerator
        .generateAST(getSql(pathNodeLength, pathNodeNumber, number));
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(DeleteTimeSeriesBenchmark.class.getSimpleName())
        .forks(1)
        .warmupIterations(10)
  ...
  private static String getSql(int pathNodeLength, int pathNodeNumber, int number) {
    ...
    deleteTimeSeriesStatement.append("delete timeseries ");
