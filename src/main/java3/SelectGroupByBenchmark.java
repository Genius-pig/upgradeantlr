 ...
 */
public class SelectGroupByBenchmark {
  ...
  @Benchmark
  public Operator select() throws QueryProcessException, MetadataException, ParseException {
    AstNode astTree = ParseGenerator
        .generateAST(getSql(prefixNodeNumber,prefixNodeLength, number));
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(SelectGroupByBenchmark.class.getSimpleName())
        .forks(1)
        .warmupIterations(10)
  ...
  private static String getSql(int prefixNodeNumber, int prefixNodeLength, int number) {
    StringBuilder selectStatement = new StringBuilder();
    selectStatement.append("select ");
    //selectElements
    selectStatement.append("count(status), max_value(temperature), min_value(temperature)");
    //fromClause
    ...
    //whereAndFillClause
    selectStatement.append(" where time > 2017-11-03T06:00:00 and temperature > 20 group by(1h, [2017-11-03T00:00:00, 2017-11-03T23:00:00])");
