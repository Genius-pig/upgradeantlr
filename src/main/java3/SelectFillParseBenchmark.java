 ...
 */
public class SelectFillParseBenchmark {
  ...
  public Operator select() throws ParseException, QueryProcessException, MetadataException {
    AstNode astTree = ParseGenerator
        .generateAST(getSql(prefixNodeNumber,prefixNodeLength, suffixNodeNumber, suffixNodeLength, number));
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
        .include(SelectFillParseBenchmark.class.getSimpleName())
        .forks(1)
        .warmupIterations(10)
  ...
  private static String getSql(int prefixNodeNumber, int prefixNodeLength, int suffixNodeNumber, int suffixNodeLength, int number) {
    ...
    //whereAndFillClause
    selectStatement.append(" where time = 2017-11-01T16:37:50.000 fill(float[previous, 1m])");
